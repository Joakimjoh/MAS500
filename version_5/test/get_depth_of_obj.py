...
def find_largest_red_object_and_get_points(color_image):
    ...
    # Lower and upper bounds for red color (HSV values)
            ...
            for p_x, p_y in points_list:
                ...
                if p_x < depth_frame.width - 1 and p_y < depth_frame.height - 1:
                    ...
                    if Z_real > 0:
                        ...
                        depth_data.append((p_x, p_y, point_tag[2][0]))  # Store z value for the pixel (p_x, p_y)
...
def find_mean_change_in_height(depth_data):
    ...
    threshold = high_diff * 0.8  # 15% above the mean change in height
