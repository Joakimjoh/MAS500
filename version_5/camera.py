...
class Camera:
    ...
    def get_tag_orientation(self):
        ...
        for i, detection in enumerate(detections):
            ...
            if ret:
                # Adjust translation in the Y-axis
                if i == 0:  # First detected tag (leftmost)
                    tvec[1] -= 0.07  # Move 7 cm negative in Y-axis
                elif i == 1:  # Second detected tag
                    tvec[1] += 0.07  # Move 7 cm positive in Y-axis
