...
while True:
    ...
    for detection in detections:
        ...
        if ret:
            ...
            pixel_x = 459  # Example pixel x-coordinate
            pixel_y = 262  # Example pixel y-coordinate
            depth_in_meters = depth_frame.get_distance(pixel_x, pixel_y)  # Depth value in meters

            # Draw the circle on the image (this will visualize the point on the image)
            cv2.circle(color_image, (pixel_x, pixel_y), 5, (0, 255, 0), 2)  # Green circle for the camera point
            ...
            if 1 in tag_poses:
                ...
                print(point_in_tag1.reshape(1, 3))
    # Display result
